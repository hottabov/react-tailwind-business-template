    ...
    <header className={headerCls}>
      <div className="section-wrapper flex items-center justify-between">
          ...
          {navLinks.map(link => (
            link.children ? (
              ...
              <NavLink
                key={link.href}
                to={link.href}
                className={({ isActive }) => `px-4 py-2 rounded-lg font-medium text-base transition-colors duration-200
                  ${isActive
        ...
        <div className="flex lg:hidden items-center gap-3">
          ...
          >
            <span className={`block h-0.5 w-5 bg-gray-700 dark:bg-gray-200 rounded-full
      ...
      <div className={`lg:hidden overflow-hidden transition-all duration-300
        ...
        <nav className="bg-white dark:bg-dark-card border-t border-gray-100 dark:border-dark-border
