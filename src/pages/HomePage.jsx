    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="section-wrapper relative z-10 text-center text-white pt-28 pb-20">
          <span className="inline-block px-4 py-1.5 rounded-full bg-brand-500/20 border border-brand-500/40
          ...
          <p className="text-xl md:text-2xl text-white/80 mb-10 max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: '0.1s' }}>
            Premium interior and exterior painting for Melbourne homes and businesses.
            Free quotes, guaranteed quality.
          </p>
          ...
          {/* Trust badges */}
          <div className="flex flex-wrap justify-center gap-6 mt-14 text-white/60 text-sm animate-fade-in"
            style={{ animationDelay: '0.4s' }}>
            {['500+ Projects Completed', '15+ Years Experience', '5-Star Google Rating', 'Same-Day Quotes'].map(b => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s, i) => (
              <Link key={s.slug} to={`/services/${s.slug}`}
                ...
                <div className="p-6">
                  <h3 className="font-display text-xl text-gray-900 dark:text-white mb-2">{s.title}</h3>
                  <p className="text-gray-500 dark:text-gray-400 text-sm line-clamp-2 mb-4">{s.summary}</p>
      ...
      <section className="py-24 bg-white dark:bg-dark-bg">
        <div className="section-wrapper grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Link to="/services" className="mt-8 inline-flex items-center gap-2 px-7 py-3.5 rounded-full
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-brand-500 text-white rounded-2xl p-5 shadow-xl">
              ...
              <div className="text-sm font-medium text-brand-100">Years in Business</div>
            </div>
            <div className="absolute -top-6 -right-6 bg-white dark:bg-dark-card rounded-2xl p-4 shadow-xl border border-gray-100 dark:border-dark-border">
              <StarRating />
              <div className="font-semibold text-gray-800 dark:text-white mt-1">5.0 Google Rating</div>
        ...
        <div className="section-wrapper">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {featuredReviews.map(r => (
              <div key={r.id} className="bg-white dark:bg-dark-bg rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-dark-border">
                <StarRating />
          ...
          <div className="text-center">
            <Link to="/reviews" className="inline-flex items-center gap-2 text-brand-500 font-semibold hover:gap-3 transition-all">
